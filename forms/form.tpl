                    ...
                    <form action="" method="post" id="forms" enctype="multipart/form-data">
                        {foreach from=$FIELDS item=field}
                            <div class="form-group">
                                ...
                                {/if}
                                {if $field.type == "1"}
                                    <input class="form-control" type="text" name="{$field.id}" id="{$field.id}" value="{$field.value}" placeholder="{$field.name}"{if $field.required} required{/if}>
                                {elseif $field.type == "2"}
                                ...
                                {elseif $field.type == "3"}
                                    <textarea class="form-control" name="{$field.id}" id="{$field.id}" value="{$field.value}"{if $field.required} required{/if}></textarea>
                                {elseif $field.type == "6"}
                                    <input type="number" class="form-control" name="{$field.id}" id="{$field.id}" value="{$field.value}" placeholder="{$field.name}"{if $field.required} required{/if}>
                                {elseif $field.type == "7"}
                                    <input type="email" class="form-control" name="{$field.id}" id="{$field.id}" value="{$field.value}" placeholder="{$field.name}"{if $field.required} required{/if}>
