...
<div class="tab-content" id="pills-tabContent">
    <div class="tab-pane fade show active" id="pills-bgelr" role="tabpanel" aria-labelledby="pills-bgelr-tab">
        {include file="./parts/image_uploader.tpl" name=lbg} {include file="./parts/image_uploader.tpl" name=rbg} {include file="./parts/switch.tpl" name=lr_modal_image right=no last=no} {include file="./parts/switch.tpl" name=lr_coverlay right=$LR_COVERLAY_2 last=no}

        {include file="./parts/switch.tpl" name=lr_sidebar right=no last=no}
